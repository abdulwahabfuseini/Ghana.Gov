...
const Search = () => {
  ...
  return (
    <div className="absolute left-0 right-0 w-full px-5 sm:-bottom-7 -bottom-24">
      <form className="grid sm:grid-cols-2 lg:grid-cols-4 sm:mx-auto sm:bg-white sm:shadow-2xl backdrop:none sm:w-[79vw] lg:w-[67vw] gap-y-2">
        <Select
        ...
        <div className="flex shadow-md sm:col-span-1 lg:col-span-3 items-cemter">
          <Divider
            sx={{ height: 60, mr: 2 }}
