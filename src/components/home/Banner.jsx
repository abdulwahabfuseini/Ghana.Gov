...
const Banner = () => {
  ...
  return (
    <div className="w-full h-full">
       <div className="relative h-60 sm:h-96 bg-slate-800">
        <img
        src="/images/banner2.png"
        alt="banner"
        className="object-cover w-full h-full md:h-96"
      />
      <div className="absolute top-0 left-0 right-0 h-full px-4 py-5 text-center bg-black sm:py-16 lg:py-24 bg-opacity-30">
